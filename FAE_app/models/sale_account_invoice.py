...
class FaeAccountInvoiceLine(models.Model):
    ...
    def unlink(self):
        for line in self:
            if line.move_id.is_invoice() and line.move_id.posted_before and not line.exclude_from_invoice_tab:
                raise ValidationError('No puede eliminar la línea contable porque está asociada con un línea de la factura')
